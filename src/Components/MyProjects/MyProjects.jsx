        ...
        <div id="projects" className="mb-5 anchor">
            ...
            <section className="container d-flex flex-wrap justify-content-center project-container">
                <article className="project-article mb-5 col-lg-5 fs-5 text-center">
                    <h3>BIT People</h3>
                    <a href="https://slobodanstojkovic.github.io/react-bit-people/" target="_blank" rel="noopener noreferrer"><img className="projectImg" src={bitPeople} alt="BIT People" /></a>
                ...
                <article className="project-article mb-5 col-lg-5 fs-5 text-center">
                    ...
                    <a href="https://slobodanstojkovic.github.io/Search-TV-Shows/" target="_blank" rel="noopener noreferrer"><img className="projectImg" src={bitShow} alt="Search TV Shows" /></a>
                ...
                <article className="project-article mb-5 col-lg-5 fs-5 text-center">
                    ...
                    <a href="https://slobodanstojkovic.github.io/GitHub-Searcher/" target="_blank" rel="noopener noreferrer"><img className="projectImg" src={gitHubSearcher} alt="GitHub Searcher" /></a>
                ...
                <article className="project-article mb-5 col-lg-5 fs-5 text-center">
                    ...
                    <a href="https://slobodanstojkovic.github.io/Rick-and-Morty-Characters/" target="_blank" rel="noopener noreferrer"><img className="projectImg" src={rickAndMorty} alt="Rick And Morty" /></a>
                    <p>Web application for browsing Rick & Morty characters. Application pulls data from API.
                    </p>
                </article>
                <article className="project-article mb-5 col-lg-5 fs-5 text-center">
                    <h3>Build Estate</h3>
                    <a href="https://slobodanstojkovic.github.io/BuildEstate/" target="_blank" rel="noopener noreferrer"><img className="projectImg" src={buildEstate} alt="Build Estate" /></a>
