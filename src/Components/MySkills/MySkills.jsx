...
export const MySkills = () => {
  return (
    <div id="skills" className="pb-5">
      <h1 className="text-center pt-4 mb-5 text-info fw-bold">
        MY SKILLS <i className="fas fa-user-secret text-center"></i>
      </h1>
      ...
      <div className="container skill-section py-5 mb-5 row">
        <div className="rowOneSkills row">
          ...
          <article className="col text-center">
            <img
              src="https://icons.iconarchive.com/icons/graphics-vibe/developer/128/javascript-icon.png"
              className="skill"
              alt="javascript"
            />
        ...
        <div className="rowTwoSkills row">
          ...
          <article className="col text-center">
            <img
              src="https://icons.iconarchive.com/icons/graphics-vibe/developer/128/css-icon.png"
              className="skill"
              alt="css"
            />
